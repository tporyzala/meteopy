...
class OptionsEnsemble:
    def __init__(self, latitude: float, longitude: float, temperature_unit=celsius, wind_speed_unit=kmh, precipitation_unit=mm, timeformat=iso8601, timezone=auto, past_days=2, forecast_days=7, models=gfs_seamless, cell_selection=land) -> None:
